...
public class PwFormatter extends HtmlFormatter implements IXwFormatter {
	...
	private static final String CLASS_METER_VALUE_NEGATIVE = "meter-value-negative";
	private static final String CLASS_METER_WRAP = "meter-wrap";
	private static final String CLASS_METER_WRAP_NEGATIVE = "meter-wrap-negative";
	...
	/**
	 * Adds a color code to document the different story lines. The idea is that
	 * instances marked with the same color code will be coming from the same
	 * story line
	 * 
	 */
	@Override
	public String addColorCode(ColorCode cc) {
		String style = "style=\"display:inline-block;margin:0 0 0 0;border:0px;padding:0px;background-color:#";
		String styleText1 = style
				+ Integer.toHexString(cc.getColorFirst().getRGB()).substring(2)
				+ "\"";
		...
		String styleText2 = style
				+ Integer.toHexString(cc.getColorSecond().getRGB()).substring(2)
				+ "\"";
		// case 2: two colors
		...
		String styleText3 = style
				+ Integer.toHexString(cc.getColorThird().getRGB()).substring(2)
				+ "\"";
	 ...
	 * @param content
	 */
	public String addExtensible(String id, String showString, String hideString,
			String content, boolean initiallyVisible) {
		// the show link
		if (initiallyVisible) {
	...
	public String addExtensibleH2(String id, String label, String content,
		...
		String showString = "<h2 class=extensible>&gt;&gt;&gt; " + label
				+ "</h2>";
		String hideString = "<h2 class=extensible>&lt;&lt;&lt; " + label
				+ "</h2>";
	...
	public String addExtensibleH3(String id, String label, String content,
			boolean initiallyVisible) {
		String showString = "<h3 class=extensible>&gt;&gt;&gt; " + label
				+ "</h3>";
		String hideString = "<h3 class=extensible>&lt;&lt;&lt; " + label
				+ "</h3>";
		addExtensible(id, showString, hideString, content, initiallyVisible);
		return toString();
	}
